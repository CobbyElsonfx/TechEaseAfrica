              ...
              As part of its services, it used to give training and digital support to companies and professionals. 
                ...
                <div>
                    ...
                    <ul className="mt-4 space-y-3 text-sm">
                        <li>
                            <Link to="programs" className="hover:text-gray-300 transition">Advance Website Development</Link>
                        </li>
                        <li>
                            <a to="programs" className="hover:text-gray-300 transition">Advance Frontend Engineering  </a>
                        </li>
                        <li>
                            <a to="programs" className="hover:text-gray-300 transition">Advance Graphic Design</a>
                        </li>
                        <li>
                            <a to="programs" className="hover:text-gray-300 transition">Advance Data Science and Analytics</a>
                        </li>
                        <li>
                            <a href="programs" className="hover:text-gray-300 transition">Advance Social Media Marketing and Advertisement </a>
                        </li>
                    </ul>
                </div>
