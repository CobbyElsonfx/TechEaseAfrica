import PeaceAwotweImg from "../assets/PeaceAwotwe.jpg"
import GladysAkuaku from "../assets/GladysAkuaku.jpg"
import Eben from '../assets/eben.jpg'



const testimonials = [
    {
      text: "Taking the Social Media Marketing course at Techease Africa has been a game-changer for me. The course is practical, hands-on, and tailored to today's digital landscape. The instructors were knowledgeable and approachable, providing real-world strategies that I could implement immediately. Whether you're a beginner or looking to refine your skills, this course will equip you with the tools and confidence needed to succeed. I highly recommend it to anyone looking to enhance their digital marketing expertise!",
      name: "Gladys Akuaku",
